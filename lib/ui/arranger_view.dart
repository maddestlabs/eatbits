  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        // Multitrack Grid & Track Panels (Pixel-Aligned Zero-Offset)
        Expanded(
          child: Row(
            children: [
              // Left Panel: Vertical Track Control Strips (ListView zero padding)
              SizedBox(
                width: 140,
              ...
              // Right Multitrack Timeline Grid (ListView zero padding, 100% aligned)
              Expanded(
                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    ...
                                                    const Spacer(),
                                                    Icon(Icons.drag_indicator, size: 10, color: DawTheme.backgroundDark),
                                                  ],
                                                ),
                                                const Spacer(),
